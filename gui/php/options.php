 <?php
    ...
    $pass = "";
      $con = new mysqli($host, "root", $pass, $db);
        ...
        $query;
        $query = "SELECT empleado.cedula, empleado.nombre, empleado.apellido, empleado.email, empleado.telefono, empleado.direccion, empleado.numero, cuenta.cargo FROM empleado, cuenta WHERE (";
          $a = 0; 
          if($_GET['opt1'] == 1){
